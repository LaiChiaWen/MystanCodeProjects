...
def main():
	"""
	TODO: Create a Sierpinski Triangle
	"""
...
def sierpinski_triangle(order, length, upper_left_x, upper_left_y):
	...
	:return: Return the Sierpinski Triangle with order
	"""
	if order == 0:
		pass
	else:
		triangle_1 = GLine(upper_left_x, upper_left_y, upper_left_x+length, upper_left_y)
		triangle_2 = GLine(upper_left_x, upper_left_y, upper_left_x+length/2, upper_left_y+0.866*length)
		triangle_3 = GLine(upper_left_x+length, upper_left_y, upper_left_x+length/2, upper_left_y+0.866*length)
